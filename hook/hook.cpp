...
extern "C" LRESULT CALLBACK callWndProcRet(
    ...
    static const COLORREF foregroundColor = getIntCfg(_T("foregroundColor"), 0x00000088);
    static const COLORREF backgroundColor = getIntCfg(_T("backgroundColor"), 0x00009900);
